      ...
      <div class="login_right">
        ...
        <form @submit.prevent="handleLogin" class="login_form">
          ...
          <div class="login_options">
            <BaseCheckbox v-model="userStore.rememberMe">记住我</BaseCheckbox>
            <BaseCheckbox v-model="userStore.autoLogin">自动登录</BaseCheckbox>
          </div>

          <BaseButton type="submit" :disabled="loading" class="login_btn">
...
import { BaseInput, BaseMessage } from '@project/ui'
